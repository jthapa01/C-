...
namespace LinkedListDynamic
{
    ...
    public class DynamicList<T>
    {
        ...
        {
            //ListNode is an example of recursive data structure that is defined by referencing itself
            public T Element { get; set; }
            public ListNode NextNode{get; set;}//recursive data structure
        ...
        public int Remove(T item)
        {
            ...
            if(currentNode != null)
            {
                //THe element is found in the list -> reove it
                RemoveListNode(currentNode, prevNode);
                return currentIndex;
            }
            else
            {
                //The element is found in the list -> return -1
                return -1;
            }
        }
