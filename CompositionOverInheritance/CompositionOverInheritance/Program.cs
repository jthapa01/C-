...
namespace CompositionOverInheritance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            * I take that to mean that when you inherit, you are making a lot of assumptions about the future. 
            * When the 'base' class evolves, so will everything 'downstream' on the inheritance chain. 
            * This could be desirable or it could create a bunch of un-used properties when dealing with edge cases.

            * I tend to prefer composition. Meaning that rather than inherit, I just implement an inteface 
            * multiple times to better tailor the modeling. In this way you can evolve each piece separately and 
            * not have to deal with the baggage of inheritance.
            */
