...
namespace IDictionary
{
    ...
    /// to correctly implement Equals() and GetHashCode()</typeparam>
        ...
        IEnumerable<KeyValuePair<K, V>>
    {
        ...
        /// <summary>
        /// Finds the chain of elements coresponding internally
        /// to given key(by its hash code)
        /// </summary>
        /// <param name="key"></param>
        /// <param name="createIfMissing">creates an ampty list
        /// of elements if the chain still does not exist</param>
        /// <returns> a lit of elements in the chain or null</returns>
        private List<KeyValuePair<K,V>> FindChain(
            K key, bool createIfMissing)
        {
            int index = key.GetHashCode();
            //The unary & operator return the address of its operand
