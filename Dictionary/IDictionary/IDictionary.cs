...
namespace IDictionary
{
    ...
    /// dictionary class which maps key to values
    /// </summary>
    ...
    {
        /// <summary>
        /// Finds the value maped to the given key
        /// the key to be searched
        /// value for the specified if it presents,
        /// or null if there is no value with such keys
        /// </summary>
